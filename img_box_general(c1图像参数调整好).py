...
class public_img(): 
    ...
    def img_box_lk(self,img,max_arce,min_arce):
        ...
        for contour in contours:  
            ...
            cv2.rectangle(imgss2, (x, y), (x+w , y+h), (255, 0, 255), 2)
            ...
            if max_arce> arce >= min_arce:
                ...
                cv2.rectangle(imgss, (x_min, y_min), (x_max , y_max), (0, 0, 255), 2)
                cv2.rectangle(img, (x_min, y_min), (x_max , y_max), (0, 255, 0), 6)
    ...
    def eroded_and_dilated_img(self,img):
        ...
        eroded = cv2.erode(eroded, kernel_1)
...
if __name__ == '__main__':  
    ...
    image = cv2.imread('.//testimg//testa//model//c1.jpg', cv2.IMREAD_GRAYSCALE)
    dir_origin_path = ".//testimg//testa//c1_img//"
    output_dir = ".//zi//"
    image_1 = ".//testimg//testa//c1_img//Image_20240126102942179.bmp" 
    ...
    #cv2.imshow("test",cv2.resize(thr_img_box,(640,320)))
